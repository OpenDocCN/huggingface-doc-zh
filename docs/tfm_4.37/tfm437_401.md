...
> 原文链接：[`huggingface.co/docs/transformers/v4.37.2/en/index#if-you-are-looking-for-custom-support-from-the-hugging-face-team`](https://huggingface.co/docs/transformers/v4.37.2/en/index#if-you-are-looking-for-custom-support-from-the-hugging-face-team)
