...
![在丛林中的宇航员，略有裁剪的生成图像](../Images/f09d2bde8c0bb94924d692c1760dfca3.png)
...
SDXL是一个庞大的模型，您可能需要优化内存才能使其在您的硬件上运行。以下是一些节省内存并加快推理速度的提示。
