...
> 原始文本：[https://huggingface.co/docs/accelerate/package_reference/state](https://huggingface.co/docs/accelerate/package_reference/state)
...
+   `distributed_type` ([DistributedType](/docs/accelerate/v0.27.2/en/package_reference/utilities#accelerate.DistributedType)) — 当前正在使用的分布式环境的类型。
...
+   `distributed_type` ([DistributedType](/docs/accelerate/v0.27.2/en/package_reference/utilities#accelerate.DistributedType)) — 当前使用的分布式环境类型。
