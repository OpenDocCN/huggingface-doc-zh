...
+   `type_vocab_size` (`int`, *optional*, 默认为2) — 在调用[AlignTextModel](/docs/transformers/v4.37.2/en/model_doc/align#transformers.AlignTextModel)时传递的`token_type_ids`的词汇表大小。
