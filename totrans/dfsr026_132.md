...
+   `feature_extractor`（[ClapFeatureExtractor](https://huggingface.co/docs/transformers/v4.37.2/en/model_doc/clap#transformers.ClapFeatureExtractor)）- 用于将生成的音频波形预处理为自动评分的log-mel频谱图的特征提取器。
